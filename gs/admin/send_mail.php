...
// require_once "library/SMTP.php";
    ...
    $mail->addAddress("fatkulumar@gmail.com", "umar"); //email penerima
    ...
    <body>
        ...
        <center><a style='background:#2C97DF; color:white; border-top:0; border-left:0; border-right:0; border-bottom:5px solid #2A80B9; padding:10px 20px; text-decoration:none; font-family:sans-serif; font-size:11pt;' href='".$url_display."'>Aktivasi</a></center>
        </div>
        <center><div>
